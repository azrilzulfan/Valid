  ...
  const floatingItems = [
    {
      ...
      top: "5%",
      left: "8%",
      className: "rotate-[-15deg] blur-[2px] z-0 scale-110",
    },
    {
      Icon: ShieldCheck,
      top: "25%",
      left: "2%",
      className: "rotate-[10deg] blur-0 z-20 scale-125",
    },
    ...
    { Icon: Star, bottom: "20%", right: "5%", className: "rotate-[-15deg] blur-0 z-20 scale-110" },
    {
      ...
      bottom: "5%",
      right: "25%",
      className: "rotate-[-30deg] blur-[5px] z-0 scale-75",
    },
  ];
    ...
    <>
      ...
      >
        <div
          ...
          style={{ background: "var(--gradient-hero-aura)" }}
        />
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 20px 40px rgba(37,99,235,0.15), inset 0 0 0 1px rgba(255,255,255,0.6), inset 2px 2px 5px rgba(255,255,255,0.8)",
              }}
            >
              <item.Icon
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center mt-10">
          ...
          >
            Bukan sekadar CV. Bukan sekadar nilai. VALID bantu kamu nunjukin kalau skill kamu memang
