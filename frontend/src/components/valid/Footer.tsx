        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 pb-16">
          ...
          <div className="md:col-span-5 flex flex-col items-start gap-4">
            ...
            <p className="text-[var(--text-muted)] text-base font-semibold leading-relaxed max-w-sm">
              Platform verifikasi peer berbasis AI untuk talenta dan pekerja vokasi Indonesia yang
              terpercaya.
            </p>
            {/* Social Links */}
          ...
          <div className="md:col-span-3 flex flex-col gap-4">
            <div className="text-xs uppercase tracking-widest font-black text-[var(--text-muted)]">
              Navigasi
            </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <a
                href="mailto:halo@valid.id"
                className="text-base font-bold text-blue-600 dark:text-blue-400 hover:underline self-start"
              >
                halo@valid.id
              </a>
            </div>
