  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden bg-[var(--bg-b)]">
        <div
          className="absolute top-[10%] -left-[10%] w-[60vw] h-[60vw] bg-rose-100/40 dark:bg-rose-900/10 rounded-full blur-[100px] mix-blend-multiply dark:mix-blend-screen opacity-70 animate-pulse"
          style={{ animationDuration: "9s" }}
        />
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-blue-100/40 dark:bg-blue-900/10 rounded-full blur-[100px] mix-blend-multiply dark:mix-blend-screen opacity-60 animate-pulse"
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 lg:pt-14">
            <p className="animate-body-text text-base md:text-xl text-[var(--text-color)] font-semibold leading-relaxed font-body max-w-lg">
              Yang bikin orang percaya itu bukan daftar skill yang panjang. Yang bikin percaya itu
              bukti, cara kamu jelasin kerjaanmu, dan pola kemampuan yang kebaca jelas.
            </p>
          </div>
        </div>
          ...
          {rows.map((r, i) => (
            ...
            >
              ...
              <div className="col-span-6 sm:col-span-3 text-right">
                <span className="text-xs font-bold text-[var(--text-muted)] mr-2 uppercase tracking-wider">
                  hingga
                </span>
                <span
