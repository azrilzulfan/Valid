        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="mb-24 flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              ...
              <h1
                className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white uppercase leading-[0.9] tracking-tighter mb-6"
                style={{ fontFamily: "var(--font-impact)" }}
              >
                Membongkar{" "}
                <span className="text-blue-600 relative inline-block">
                  Kepalsuan.
                  <span className="absolute bottom-1 left-0 w-full h-3 bg-yellow-300 -z-10 transform -rotate-1"></span>
                </span>
                <br />
              ...
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 font-medium max-w-xl leading-relaxed">
                Kami membangun VALID bukan sekadar untuk menjadi platform portofolio biasa. Kami
                lahir dari rasa frustrasi melihat betapa mudahnya klaim keahlian palsu mengelabui
                proses rekrutmen. Sudah saatnya skill nyata mendapatkan tempat yang layak.
              </p>
            </div>
            ...
            <div className="flex-1 w-full relative">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-[2rem] p-8 md:p-12 border-[3px] border-slate-900 relative shadow-[8px_8px_0px_#0f172a]">
                ...
                <p className="text-slate-600 dark:text-slate-300 font-medium mb-6">
                  Menciptakan ekosistem profesional di mana kejujuran adalah mata uang utama, dan
                  kompetensi dibuktikan dengan data, bukan retorika.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {[
              ...
              <div
                key={i}
                className={`${stat.color} rounded-[2rem] p-8 border-[3px] border-slate-900 shadow-[6px_6px_0px_#0f172a] transform transition-transform hover:-translate-y-2`}
              >
                <h4
                  className={`text-5xl font-black mb-2 ${stat.textColor === "text-white" ? "text-white" : "text-slate-900"}`}
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  {stat.title}
                </h4>
                <div
                  className={`text-sm font-bold uppercase tracking-widest mb-4 ${stat.textColor === "text-white" ? "text-blue-200" : "text-slate-500"}`}
                >
                  {stat.subtitle}
                </div>
                <p
                  className={`font-medium ${stat.textColor === "text-white" ? "text-blue-100" : "text-slate-700"}`}
                >
                  {stat.desc}
                </p>
              </div>
          ...
          <div className="bg-[var(--card-bg)] rounded-[3rem] border-[4px] border-[var(--border-color)] p-8 md:p-16 shadow-[12px_12px_0px_var(--shadow-color)]">
            <h2
              className="text-4xl md:text-5xl font-black text-center mb-16 uppercase tracking-tighter"
              style={{ fontFamily: "var(--font-impact)" }}
            >
              Pilar Kepercayaan VALID
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 font-medium">
                    Setiap nilai dan verifikasi yang diberikan memiliki jejak analisis yang jelas.
                    Tidak ada blackbox, semua terbuka agar kamu mengerti di mana kelebihan dan
                    kekuranganmu.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 font-medium">
                    Dalam hitungan detik, sistem kami melakukan screening yang biasanya memakan
                    waktu berjam-jam secara manual, memberikan hasil yang cepat dan bebas dari bias
                    manusia.
                  </p>
                </div>
              </div>
