      ...
      <div className="relative z-10 flex flex-col justify-between h-full">
        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants}>
          <motion.div variants={itemVariants}>
            ...
            />
            <h1
              className="text-3xl sm:text-4xl md:text-5xl font-black uppercase leading-[0.9] tracking-tighter text-[var(--text-color)]"
        ...
        >
          <motion.div
            ...
            className="bg-[var(--card-bg)] border-[3.5px] border-[var(--border-color)] rounded-[2rem] p-8 shadow-[8px_8px_0px_var(--shadow-color)] relative mt-8 transform -rotate-1 hover:rotate-0 transition-transform duration-300"
          >
            <div
              className="text-7xl font-black text-yellow-400 absolute -top-8 -left-4 transform -rotate-12"
              style={{ fontFamily: "var(--font-display)" }}
            >
              "
            </div>
            <p
              className="text-lg font-bold text-[var(--text-color)] leading-relaxed mt-2"
            ...
            <div className="flex items-center gap-4 mt-6 pt-6 border-t-[2.5px] border-dashed border-[var(--border-color)]">
              ...
              <div>
                <div
                  className="font-black text-[var(--text-color)] text-sm uppercase tracking-wide"
                  style={{ fontFamily: "var(--font-display)" }}
                >
                  Rizky P.
                </div>
        ...
        >
          {[
            ...
            <motion.div
              key={i}
              variants={itemVariants}
              className="bg-[var(--card-bg)] border-[3px] border-[var(--border-color)] rounded-[1.5rem] p-5 shadow-[5px_5px_0px_var(--shadow-color)] transform hover:-translate-y-1 transition-transform"
            >
              <div
              ...
              <div className="text-[11px] font-black uppercase tracking-widest text-[var(--text-muted)] mt-1">
                {stat.label}
              </div>
            </motion.div>
          ))}
