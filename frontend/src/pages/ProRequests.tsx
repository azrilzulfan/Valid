...
const INCOMING_REQUESTS = [
  {
    ...
    date: "25 Mei 2026",
    status: "Menunggu",
    message: "Mohon direview fokus pada detail komunikasi saya ya pak, terima kasih.",
  },
  {
    id: 2,
    name: "Ayu Lestari",
    ...
    date: "24 Mei 2026",
    status: "Menunggu",
    message: "Saya baru mencoba wawancara pertama kali.",
  },
  {
    id: 8,
    name: "Dimas Anggara",
    ...
    date: "25 Mei 2026",
    status: "Menunggu",
    message: "Portofolio pengelasan saya sudah diupdate.",
  },
  {
    id: 3,
    name: "Fajar Nugraha",
    ...
    <div className="flex w-full h-screen bg-[#F0F4F8] overflow-hidden text-[var(--text-color)] font-sans">
      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          >
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                Kandidat-kandidat ini sedang menunggu *feedback* darimu. Selesaikan review untuk
                mendapatkan koin.
              </p>
            </div>
          ...
          <motion.div
            variants={sectionVariants}
            className="flex bg-white border-[3px] border-slate-900 rounded-[1rem] p-1.5 shadow-[4px_4px_0px_#0f172a] mb-[24px] max-w-fit"
          >
          ...
          <motion.div
            variants={sectionVariants}
            className="bg-white border-[3px] border-slate-900 rounded-[1.5rem] shadow-[6px_6px_0px_#0f172a] overflow-hidden"
          >
            <div className="divide-y-[3px] divide-slate-900 flex flex-col">
              {INCOMING_REQUESTS.filter(
                ...
                <div
                  key={req.id}
                  className="p-[24px] flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-slate-50 transition-colors group"
                >
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-2">
                        <h3
                          className="font-black text-[18px] text-slate-900 uppercase tracking-tight"
                          style={{ fontFamily: "var(--font-impact)" }}
                        >
                          {req.name}
                        </h3>
                      ...
                      <div className="flex items-center gap-3 mb-3 flex-wrap">
                        <span
                          className="font-bold text-[11px] text-slate-600 tracking-widest flex items-center gap-1 uppercase"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                      ...
                      <div className="bg-blue-50 border-[2px] border-dashed border-blue-200 rounded-lg p-3 inline-block w-full max-w-2xl">
                        <p
                          className="font-bold text-[12px] text-slate-700 italic leading-relaxed"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          "{req.message}"
                        </p>
              ...
              {INCOMING_REQUESTS.filter(
                ...
                <div className="p-[60px] text-center bg-slate-50">
                  ...
                  <div
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Tidak ada permintaan review ditemukan
                  </div>
                </div>
              )}
            </div>
