      ...
      <div className="fixed md:relative bottom-0 left-0 w-full md:w-[260px] h-[75px] md:h-screen bg-[var(--card-bg)] md:border-r-[3px] border-t-[3px] md:border-t-0 border-[var(--border-color)] flex md:flex-col z-50 md:z-auto transition-all shrink-0">
        ...
        <div className="hidden md:flex items-center gap-3 py-[20px] px-[24px] border-b-[3px] border-[var(--border-color)] bg-[var(--bg-a)]">
          ...
          <div className="flex flex-col">
            ...
            <span
              className="font-bold text-[9px] uppercase tracking-widest text-[var(--text-muted)] mt-1"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Reviewer Ahli
            </span>
        ...
        <div className="hidden md:flex flex-col p-[24px] border-t-[3px] border-[var(--border-color)] bg-[var(--bg-a)]">
          ...
          >
            ...
            <span
              className="font-black text-[12px] uppercase tracking-widest text-[var(--text-muted)] group-hover:text-red-500 transition-colors"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Keluar
            </span>
      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          <motion.div variants={sectionVariants} className="mb-[40px]">
            ...
            <p
              className="font-bold text-[14px] md:text-[16px] text-[var(--text-muted)] max-w-[600px] leading-relaxed"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Kelola permintaan ulasan wawancara, berikan feedback membangun, dan tarik penghasilan
              dari kontribusimu.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-[var(--card-bg)] border-[3px] border-[var(--border-color)] rounded-[1.5rem] p-[28px] shadow-[6px_6px_0px_var(--shadow-color)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_var(--shadow-color)] transition-all duration-300">
              ...
              <div
                className="font-black text-[12px] text-[var(--text-muted)] uppercase tracking-widest"
                style={{ fontFamily: "var(--font-body)" }}
              >
                Review Selesai
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-[32px]">
              ...
              <div className="bg-[var(--card-bg)] border-[3px] border-[var(--border-color)] rounded-[1.5rem] shadow-[6px_6px_0px_var(--shadow-color)] overflow-hidden">
                <div className="divide-y-[3px] divide-slate-900">
                  {INCOMING_REQUESTS.filter(
                    (req) => activeTab === "Semua" || req.status === activeTab,
                  ).map((req) => (
                    <div
                      key={req.id}
                      className="p-[20px] md:p-[24px] flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-slate-50 transition-colors group"
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <span
                              className="font-bold text-[11px] text-[var(--text-muted)] tracking-wider flex items-center gap-1"
                              style={{ fontFamily: "var(--font-body)" }}
                            >
                      ...
                      <div className="flex items-center gap-4 justify-between md:justify-end border-t-[2px] border-dashed border-slate-200 md:border-0 pt-4 md:pt-0">
                        ...
                        {req.status === "Menunggu" ? (
                          ...
                          <button className="bg-[var(--card-bg)] hover:bg-slate-100 dark:hover:bg-slate-800 text-[var(--text-color)] rounded-lg p-[10px] border-[2.5px] border-[var(--border-color)] shadow-[3px_3px_0px_var(--shadow-color)] hover:shadow-[4px_4px_0px_var(--shadow-color)] hover:-translate-y-0.5 transition-all shrink-0">
            ...
            <motion.div variants={sectionVariants} className="lg:col-span-1">
              ...
              <div className="bg-[var(--card-bg)] border-[3px] border-[var(--border-color)] rounded-[1.5rem] shadow-[6px_6px_0px_var(--shadow-color)] p-[24px]">
                <div
                  className="font-bold text-[12px] text-[var(--text-muted)] uppercase tracking-widest mb-1"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                ...
                <div className="flex justify-between mt-2 px-1">
                  {["S", "S", "R", "K", "J", "S", "M"].map((day, i) => (
                    <span
                      key={i}
                      className={`font-black text-[10px] w-[24px] text-center uppercase tracking-widest ${i === 6 ? "text-[var(--text-color)]" : "text-slate-400"}`}
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {day}
                    </span>
                ...
                <button
                  className="w-full mt-6 bg-[var(--bg-a)] hover:bg-slate-100 dark:hover:bg-slate-800 text-[var(--text-color)] rounded-xl py-[12px] font-black text-[11px] uppercase tracking-widest border-[2.5px] border-[var(--border-color)] shadow-[3px_3px_0px_var(--shadow-color)] hover:-translate-y-0.5 transition-all"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Tarik Saldo Koin
                </button>
