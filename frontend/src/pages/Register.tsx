                ...
                <div className="flex flex-col gap-5 mt-8 w-full">
                  ...
                  <div
                    ...
                    className={`relative border-[3px] rounded-[1.5rem] p-6 cursor-pointer bg-[var(--card-bg)] transition-all duration-300 ${
                      role === "pencari_kerja"
                        ? "border-blue-600 shadow-[6px_6px_0px_#2563eb] -translate-y-1"
                        : "border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_var(--shadow-color)]"
                    }`}
                  >
                    {role === "pencari_kerja" && (
                    ...
                    <div
                      className={`w-12 h-12 rounded-xl border-[2.5px] border-[var(--border-color)] flex items-center justify-center shadow-[2px_2px_0px_var(--border-color)] ${role === "pencari_kerja" ? "bg-blue-600 text-white" : "bg-blue-100 text-blue-600"}`}
                    >
                      <svg
                        width="24"
                        height="24"
                    ...
                    <div
                      className="text-xl font-black text-[var(--text-color)] uppercase tracking-tight mt-4"
                      style={{ fontFamily: "var(--font-impact)" }}
                    >
                      Pencari Kerja
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      {["AI Interview", "Portfolio", "Gratis"].map((p) => (
                        <div
                          key={p}
                          className="px-3 py-1 rounded-lg border-2 border-[var(--border-color)] bg-[var(--bg-a)] text-[10px] font-black uppercase tracking-widest text-[var(--text-color)] shadow-[2px_2px_0px_var(--border-color)]"
                        >
                          {p}
                        </div>
                      ))}
                  ...
                  <div
                    ...
                    className={`relative border-[3px] rounded-[1.5rem] p-6 cursor-pointer bg-[var(--card-bg)] transition-all duration-300 ${
                      role === "pro"
                        ? "border-yellow-500 shadow-[6px_6px_0px_#eab308] -translate-y-1"
                        : "border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_var(--shadow-color)]"
                    }`}
                  >
                    {role === "pro" && (
                    ...
                    <div
                      className={`w-12 h-12 rounded-xl border-[2.5px] border-[var(--border-color)] flex items-center justify-center shadow-[2px_2px_0px_var(--border-color)] ${role === "pro" ? "bg-yellow-400 text-slate-900" : "bg-yellow-100 text-yellow-600"}`}
                    >
                      <svg
                        width="24"
                        height="24"
            ...
            {step === 2 && (
              ...
              >
                <div>
                  ...
                  <p className="mt-4 text-[var(--text-muted)] font-semibold text-sm">
                    {role === "pencari_kerja"
                      ? "Lengkapi profil pencari kerjamu."
                      : "Lengkapi data profesional BNSP kamu."}
                  </p>
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--text-muted)] hover:text-[var(--text-color)]"
                        >
                          <svg
                            width="20"
                            height="20"
                        ...
                        >
                          ...
                          <div className="group border-[2.5px] border-dashed border-[var(--border-color)] rounded-2xl bg-[var(--bg-a)] p-8 text-center cursor-pointer transition-colors duration-300 hover:border-yellow-500 hover:bg-yellow-500/5">
                            <svg
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              className="mx-auto text-[var(--text-muted)] group-hover:text-yellow-500 transition-colors"
                            >
                              <path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242" />
                              <path d="M12 12v9" />
                              <path d="m8 16 4-4 4 4" />
                            </svg>
                            <div className="text-[13px] font-bold text-[var(--text-color)] mt-4">
                              Klik atau seret dokumen BNSP ke sini
                            </div>
                            <div className="text-[11px] font-black uppercase tracking-wider text-[var(--text-muted)] mt-2">
                          ...
                          <div className="flex items-start gap-3 bg-yellow-100 dark:bg-yellow-900/30 border-[2.5px] border-[var(--border-color)] rounded-xl p-4 mt-1 shadow-[4px_4px_0px_var(--shadow-color)]">
                            ...
                            <span className="text-[13px] font-bold text-[var(--text-color)]">
                              Akun profesional memerlukan verifikasi admin sebelum dapat digunakan.
                            </span>
                          </div>
                        </motion.div>
                      )}
              ...
              >
                ...
                <div className="bg-[var(--card-bg)] border-[3.5px] border-[var(--border-color)] rounded-[2rem] p-6 sm:p-8 shadow-[8px_8px_0px_var(--shadow-color)] mt-8">
                  ...
                  <div className="flex justify-between items-center py-3">
                    ...
                    <span className="text-sm font-bold text-[var(--text-color)]">
                      {role === "pencari_kerja" ? "Pencari Kerja" : "Profesional BNSP"}
                    </span>
                  </div>
                  {role === "pro" && (
                    <>
