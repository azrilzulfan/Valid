    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[16px] mb-[40px]">
        ...
        >
          ...
          <div
            className="text-purple-900 text-[40px] md:text-[48px] font-black leading-none mt-[8px]"
            style={{ fontFamily: "var(--font-impact)" }}
          >
            Rp 2,4jt
          </div>
      ...
      <div className="flex flex-col lg:flex-row gap-[24px]">
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div
                key={idx}
                className="flex justify-between items-center p-[14px] border-[2.5px] border-[var(--border-color)] bg-[var(--bg-a)] rounded-[14px]"
              >
                ...
                <span
                  className="text-[var(--text-muted)] text-[11px] font-black uppercase shrink-0"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  {activity.time}
                </span>
        ...
        <motion.div
          variants={itemVariants}
          className="bg-yellow-300 border-[3px] border-[var(--border-color)] shadow-[8px_8px_0px_var(--shadow-color)] rounded-[24px] p-[24px_28px] flex-[4] flex flex-col"
        >
          <h2
