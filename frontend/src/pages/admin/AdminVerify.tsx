...
const DUMMY_PENDING = [
  ...
  },
  {
    id: 3,
    name: "Ahmad Fauzi",
    spec: "Pemrograman Web",
    bnsp: "BNSP-11111-2024",
    validUntil: "Jan 2027",
    time: "5 jam lalu",
    status: "MENUNGGU",
  },
...
export function AdminVerify() {
  ...
  return (
    <div className="w-full max-w-[1000px] mx-auto pb-20">
      <AdminPageHeader title="VERIFIKASI BNSP" subtitle="VERIFIKASI" />
      <p
      ...
      <div className="flex flex-col gap-[20px]">
        {filteredData.map((item) => (
          ...
          >
            {item.status === "MENUNGGU" && <div className="h-[6px] w-full bg-yellow-400" />}
            {item.status === "DISETUJUI" && <div className="h-[6px] w-full bg-green-500" />}
            {item.status === "DITOLAK" && <div className="h-[6px] w-full bg-red-500" />}
            ...
            <div className="p-[24px_32px]">
              ...
              <div className="flex justify-between items-start">
                <div className="flex gap-[16px] items-center">
                  <div className="w-[56px] h-[56px] rounded-[14px] border-[2px] border-slate-900 bg-blue-500 flex items-center justify-center shrink-0 shadow-[2px_2px_0px_#0f172a]">
                    <span
                      className="text-white text-[24px] font-black uppercase"
                  ...
                  <div>
                    ...
                    <p
                      className="text-[var(--text-color)] text-[14px] font-bold uppercase"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {item.spec}
                    </p>
                ...
                {/* Status Badge */}
                <div
                  className={`px-[16px] py-[8px] rounded-full border-[2.5px] border-[var(--border-color)] shadow-[2px_2px_0px_var(--border-color)] text-[12px] font-black uppercase tracking-wider ${
              ...
              <div className="flex flex-wrap gap-[32px] mt-[24px] pt-[20px] border-t-[3px] border-[var(--border-color)]">
                <div>
                  <div
                    className="text-[var(--text-muted)] text-[11px] font-black uppercase tracking-widest"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    NOMOR BNSP
                  </div>
              ...
              <div className="mt-[24px] bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[14px] p-[16px_20px] flex items-center justify-between">
                <div className="flex items-center gap-[12px]">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Sertifikat_BNSP_{item.name.split(" ")[0]}.pdf
                  </span>
                </div>
                <button
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            ...
            >
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                {data.find((u) => u.id === approveModal)?.name} akan mendapat akses penuh sebagai
              ...
              <div className="mt-[24px] bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[16px] p-[16px]">
                <div className="flex justify-between items-center mb-2">
                  <span
                    className="text-[var(--text-muted)] text-[12px] font-black uppercase"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Nama
                  </span>
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {data.find((u) => u.id === approveModal)?.name}
                  </span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span
                  ...
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {data.find((u) => u.id === approveModal)?.bnsp}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span
                    ...
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {data.find((u) => u.id === approveModal)?.spec}
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="mt-[24px]">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {["Dokumen tidak valid", "Nomor BNSP tidak ditemukan", "Foto tidak jelas"].map(
                    (reason) => (
                      <button
                        key={reason}
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-[4px] p-4">
            ...
            >
              <div className="p-[20px_24px] flex justify-between items-center border-b-[3px] border-[var(--border-color)] bg-yellow-300">
                <span
                  className="text-slate-900 text-[16px] font-black uppercase"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  Sertifikat_BNSP_{data.find((u) => u.id === docViewer)?.name?.split(" ")[0]}.pdf
                </span>
                <button
                  onClick={() => setDocViewer(null)}
                  className="flex items-center justify-center w-[36px] h-[36px] rounded-[10px] border-[2px] border-slate-900 bg-white hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#0f172a] transition-all text-slate-900"
                >
              ...
              <div className="h-[450px] bg-[var(--bg-a)] flex flex-col items-center justify-center gap-4">
                ...
                <span
                  className="text-[var(--text-color)] text-[16px] font-black uppercase tracking-widest mt-2"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  Preview Dokumen BNSP
                </span>
              </div>
