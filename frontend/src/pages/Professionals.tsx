...
const DUMMY_PROFESSIONALS = [
  {
    ...
    about:
      "Saya adalah praktisi teknik mesin dengan lebih dari 12 tahun pengalaman di industri manufaktur otomotif. Fokus utama saya adalah optimasi proses produksi dan memastikan standar mutu (QA/QC) sesuai spesifikasi ISO. Saya juga asesor tersertifikasi BNSP untuk bidang pengelasan dan permesinan dasar.",
    experience: [
    ...
    user_reviews: [
      {
        name: "Andi M.",
        text: "Review yang diberikan sangat detail, terutama di bagian efisiensi material. Sangat membantu!",
      },
      {
        name: "Rina S.",
        text: "Feedback nya membangun dan langsung bisa diimplementasikan di proyek akhir kuliah saya.",
      },
    ],
  },
  {
    ...
    about:
      "Desainer multi-disiplin yang berfokus pada perancangan identitas merek visual (Branding) dan pengalaman pengguna (UI/UX). Telah menangani lebih dari 50 klien UMKM hingga perusahaan multinasional. Tersertifikasi Adobe Creative Professional.",
    experience: [
    ...
    user_reviews: [
      {
        name: "Dion W.",
        text: "Sangat jeli melihat komposisi warna. Portofolio saya jadi terlihat lebih profesional berkat masukan Kak Siti.",
      },
  ...
  },
  {
    ...
    about:
      "Software engineer spesialis pengembangan aplikasi web berskala enterprise. Berpengalaman merancang arsitektur microservices dan integrasi API yang kompleks. Aktif berkontribusi di komunitas open-source dan bersertifikasi arsitek cloud AWS.",
    experience: [
    ...
    user_reviews: [
      {
        name: "Kevin O.",
        text: "Code review nya tajam! Bugs yang selama ini ga kelihatan berhasil ditemukan.",
      },
      {
        name: "Yusuf A.",
        text: "Sangat direkomendasikan untuk mereview struktur database relasional.",
      },
    ],
  },
  {
    ...
    about:
      "Lulusan terbaik jurusan Akuntansi yang kini menjabat sebagai auditor eksternal. Membantu berbagai startup dalam merapikan laporan keuangan dan memastikan kepatuhan pajak sesuai regulasi terbaru di Indonesia.",
    experience: [
    ...
    user_reviews: [
      {
        name: "Sinta P.",
        text: "Membantu saya memahami kesalahan dalam pencatatan arus kas. Terima kasih banyak!",
      },
      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto bg-[var(--bg-a)] relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-[var(--card-bg)] border-[2.5px] border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] rounded-[1.5rem] p-[20px] flex flex-col md:flex-row gap-[16px] items-stretch md:items-center mb-[32px]"
          >
            ...
            {["Semua Keahlian", "Semua Harga", "Rating Tertinggi"].map((label, i) => (
              <select
                key={i}
                className="bg-[var(--bg-a)] border-[2px] border-[var(--border-color)] rounded-[12px] py-[12px] px-[16px] font-bold text-[14px] text-[var(--text-color)] min-w-[160px] focus:outline-none focus:border-blue-600 focus:shadow-[2px_2px_0px_#2563EB] cursor-pointer appearance-none transition-all"
                style={{ fontFamily: "var(--font-body)" }}
              >
                <option>{label}</option>
              </select>
            ...
            {DUMMY_PROFESSIONALS.map((prof) => (
              ...
              >
                ...
                <div className="flex gap-[16px] items-center">
                  <div
                    className="w-[56px] h-[56px] rounded-[14px] border-[2px] border-slate-900 shadow-[2px_2px_0px_#0f172a] flex items-center justify-center font-black text-[24px] text-white shrink-0"
                    style={{ background: prof.gradient, fontFamily: "var(--font-impact)" }}
                  >
                    {prof.name
                      .split(" ")
                      .map((n) => n[0])
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center p-[24px_32px] border-b-[3px] border-slate-900 bg-yellow-300 sticky top-0 z-10">
                <div
                  className="font-black text-[24px] uppercase text-slate-900"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  PROFIL REVIEWER
                </div>
              ...
              <div className="p-[32px] flex-1">
                ...
                <div className="flex gap-[20px] items-center mb-[32px]">
                  <div
                    className="w-[80px] h-[80px] rounded-[20px] border-[3px] border-slate-900 shadow-[4px_4px_0px_#0f172a] flex items-center justify-center font-black text-[36px] text-white shrink-0"
                    style={{ background: viewProf.gradient, fontFamily: "var(--font-impact)" }}
                  >
                    {viewProf.name
                      .split(" ")
                      .map((n) => n[0])
                  ...
                  <div>
                    <div
                      className="font-black text-[28px] text-[var(--text-color)] uppercase leading-none"
                      style={{ fontFamily: "var(--font-impact)" }}
                    >
                      {viewProf.name}
                    </div>
                    <div
                      className="font-bold text-[14px] text-[var(--text-muted)] mt-[8px]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {viewProf.headline}
                    </div>
                    <div
                      className="bg-blue-100 border-[2px] border-blue-600 rounded-lg px-[10px] py-[4px] font-black text-[10px] tracking-widest text-blue-700 shadow-[2px_2px_0px_#2563eb] inline-block mt-[8px]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      ASAL ASESOR BNSP
                    </div>
                ...
                <div className="grid grid-cols-3 gap-[16px] mb-[32px]">
                  <div className="bg-[var(--card-bg)] border-[2.5px] border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] rounded-[16px] p-[16px] text-center">
                    <div
                      className="font-black text-[28px] text-[var(--text-color)] flex justify-center items-center gap-[4px]"
                      style={{ fontFamily: "var(--font-impact)" }}
                    >
                      {viewProf.rating}{" "}
                      <Star className="w-[18px] h-[18px] text-yellow-400 fill-yellow-400 -mt-1" />
                    </div>
                    <div
                      className="font-bold text-[10px] uppercase tracking-widest text-[var(--text-muted)] mt-[4px]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      RATING
                    </div>
                  ...
                  <div className="bg-[var(--card-bg)] border-[2.5px] border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] rounded-[16px] p-[16px] text-center">
                    <div
                      className="font-black text-[28px] text-[var(--text-color)]"
                      style={{ fontFamily: "var(--font-impact)" }}
                    >
                      {viewProf.verified_projects}
                    </div>
                    <div
                      className="font-bold text-[10px] uppercase tracking-widest text-[var(--text-muted)] mt-[4px]"
                      style={{ fontFamily: "var(--font-body)" }}
                ...
                <div className="mb-[32px]">
                  <div
                    className="font-black text-[18px] uppercase text-[var(--text-color)] mb-[12px] flex items-center gap-[8px]"
                    style={{ fontFamily: "var(--font-impact)" }}
                  >
                  ...
                  <div
                    className="font-bold text-[14px] text-[var(--text-muted)] leading-relaxed"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {viewProf.about}
                  </div>
                ...
                <div className="mb-[32px]">
                  <div
                    className="font-black text-[18px] uppercase text-[var(--text-color)] mb-[16px] flex items-center gap-[8px]"
                    style={{ fontFamily: "var(--font-impact)" }}
                  >
                  ...
                  <div className="flex flex-col gap-[16px]">
                    {viewProf.experience.map((exp, i) => (
                      <div key={i} className="flex gap-[16px]">
                        ...
                        <div>
                          <div
                            className="font-black text-[14px] uppercase text-[var(--text-color)]"
                            style={{ fontFamily: "var(--font-impact)" }}
                          >
                            {exp.role}
                          </div>
                          <div
                            className="font-bold text-[13px] text-blue-600 mt-[2px]"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            {exp.company}
                          </div>
                          <div
                            className="font-bold text-[11px] text-[var(--text-muted)] mt-[2px]"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            {exp.year}
                          </div>
                ...
                <div className="mb-[40px]">
                  ...
                  <div className="flex flex-col gap-[16px]">
                    {viewProf.user_reviews.map((rev, i) => (
                      <div
                        key={i}
                        className="bg-white border-[2.5px] border-[var(--border-color)] rounded-[16px] p-[16px] shadow-[4px_4px_0px_var(--shadow-color)] relative"
                      >
                        ...
                        <div className="flex items-center gap-[4px] mb-[8px]">
                          {[...Array(5)].map((_, idx) => (
                            <Star
                              key={idx}
                              className="w-[12px] h-[12px] text-yellow-400 fill-yellow-400"
                            />
                          ))}
                        </div>
                        <div
                          className="font-bold text-[13px] text-[var(--text-color)] leading-relaxed italic"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          "{rev.text}"
                        </div>
                        <div
                          className="font-black text-[11px] uppercase text-[var(--text-muted)] mt-[12px]"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          — {rev.name}
                        </div>
              ...
              <div className="p-[24px_32px] border-t-[3px] border-slate-900 bg-white sticky bottom-0 z-10 flex items-center justify-between">
                <div>
                  <div
                    className="font-bold text-[10px] uppercase tracking-widest text-[var(--text-muted)]"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    TARIF REVIEW
                  </div>
                ...
                <button
                  ...
                  className="bg-blue-600 border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] hover:shadow-[6px_6px_0px_#0f172a] rounded-[16px] px-[32px] py-[16px] font-black text-[14px] uppercase tracking-widest text-white hover:-translate-y-1 transition-all"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Minta Review
                </button>
          ...
          <>
            ...
            >
              <div
                ...
                style={{ minHeight: modalStep === 3 ? "400px" : "560px" }}
              >
                <AnimatePresence mode="wait">
                    ...
                    >
                      <div className="p-[24px_28px] border-b-[2.5px] border-[var(--border-color)] flex justify-between items-start bg-yellow-300">
                        <div>
                          ...
                          <div
                            className="font-bold text-[13px] text-slate-800 mt-[4px]"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            Isi informasi apa yang ingin direview oleh ahli.
                          </div>
                        </div>
                        <button
                          onClick={closeModal}
                          className="w-[32px] h-[32px] bg-white border-[2px] border-slate-900 shadow-[2px_2px_0px_#0f172a] rounded-lg flex items-center justify-center hover:-translate-y-0.5 transition-transform"
                        >
                          <X className="w-5 h-5 text-slate-900" />
                        </button>
                      </div>
                      ...
                      {activeProf ? (
                        <div className="p-[16px_28px] bg-blue-50 border-b-[2.5px] border-[var(--border-color)] flex gap-[12px] items-center">
                          <div
                            className="w-[40px] h-[40px] rounded-[10px] border-[2px] border-slate-900 flex items-center justify-center font-black text-[14px] text-white shadow-[2px_2px_0px_#0f172a]"
                            style={{
                              background: activeProf.gradient,
                          ...
                          <div className="flex flex-col">
                            <span
                              className="font-black text-[11px] uppercase text-blue-600 tracking-widest"
                              style={{ fontFamily: "var(--font-body)" }}
                            >
                              Reviewer Terpilih:
                            </span>
                            <span
                              className="font-black text-[16px] uppercase text-[var(--text-color)] leading-tight mt-1"
                              style={{ fontFamily: "var(--font-impact)" }}
                            >
                              {activeProf.name}
                            </span>
                        ...
                        <div className="p-[16px_28px] bg-red-50 border-b-[2.5px] border-[var(--border-color)]">
                          <span className="font-bold text-[13px] text-red-600">
                            Error: Pilih reviewer terlebih dahulu dari halaman utama.
                          </span>
                        </div>
                      )}
                      ...
                      <div className="p-[20px_28px] flex-1 overflow-y-auto bg-white">
                        ...
                        <div className="mb-[20px]">
                          <label
                            className="font-black text-[12px] uppercase text-[var(--text-color)] mb-[8px] flex items-center gap-[8px]"
                            style={{ fontFamily: "var(--font-impact)" }}
                          >
                          ...
                          <select
                            ...
                            className="w-full bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[12px] p-[12px_16px] font-bold text-[14px] text-[var(--text-color)] focus:outline-none focus:border-blue-600 focus:shadow-[4px_4px_0px_#2563EB] cursor-pointer appearance-none transition-all"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                      ...
                      <div className="p-[20px_28px] border-t-[2.5px] border-[var(--border-color)] bg-[var(--bg-a)] flex justify-between items-center">
                        <div className="flex items-center gap-[6px]">
                          ...
                          <span
                            className="font-bold text-[10px] uppercase text-slate-600 tracking-widest mt-1"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            koin
                          </span>
                        ...
                        <button
                          ...
                          className={`rounded-[12px] px-[32px] py-[12px] font-black text-[14px] uppercase tracking-widest text-white transition-all ${
                            activeProf
                              ? "bg-blue-600 border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_#0f172a]"
                              : "bg-slate-300 border-[2.5px] border-slate-400 cursor-not-allowed"
                          }`}
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          Lanjut Bayar →
                    ...
                    >
                      <div className="p-[24px_28px] border-b-[2.5px] border-[var(--border-color)] flex justify-between items-start bg-blue-600 text-white">
                        <div>
                          ...
                          <div
                            className="font-bold text-[13px] text-blue-100 mt-[4px]"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            Periksa rincian sebelum menyelesaikan pesanan.
                          </div>
                        </div>
                        <button
                          onClick={closeModal}
                          className="w-[32px] h-[32px] bg-white border-[2px] border-slate-900 shadow-[2px_2px_0px_#0f172a] rounded-lg flex items-center justify-center"
                        >
                          <X className="w-5 h-5 text-slate-900" />
                        </button>
                      </div>
                      ...
                      <div className="p-[24px_28px] flex-1 overflow-y-auto bg-[var(--bg-a)]">
                        <div className="bg-white border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] rounded-[16px] p-[24px]">
                          <div className="flex gap-[16px] items-center mb-[20px]">
                            <div
                              className="w-[48px] h-[48px] rounded-[12px] border-[2px] border-slate-900 shadow-[2px_2px_0px_#0f172a] flex items-center justify-center font-black text-[18px] text-white shrink-0"
                              style={{
                                background: activeProf.gradient,
                                fontFamily: "var(--font-impact)",
                              }}
                            ...
                            <div
                              className="font-black text-[18px] uppercase text-[var(--text-color)] flex-1"
                              style={{ fontFamily: "var(--font-impact)" }}
                            >
                              {activeProf.name}
                            </div>
                          ...
                          <div className="flex flex-col gap-[16px]">
                            <div>
                              <span
                                className="font-bold text-[11px] text-[var(--text-muted)] uppercase tracking-widest block mb-[4px]"
                                style={{ fontFamily: "var(--font-body)" }}
                              >
                                PROYEK YANG DIREVIEW
                              </span>
                              <div
                                className="font-black text-[15px] uppercase text-blue-600 bg-blue-50 border-[2px] border-blue-200 p-[10px_12px] rounded-lg"
                                style={{ fontFamily: "var(--font-impact)" }}
                              >
                            ...
                            {customNote && (
                              <div>
                                ...
                                <div
                                  className="font-bold text-[13px] text-slate-700 bg-slate-50 border-[2px] border-slate-200 p-[12px] rounded-lg italic"
                                  style={{ fontFamily: "var(--font-body)" }}
                                >
                                  "{customNote}"
                                </div>
                            ...
                            <div className="flex justify-between items-center">
                              <span
                                className="font-black text-[14px] text-[var(--text-muted)] uppercase tracking-widest"
                                style={{ fontFamily: "var(--font-impact)" }}
                              >
                                TOTAL BIAYA
                              </span>
                              <div className="flex items-center gap-[6px] bg-yellow-300 border-[2px] border-slate-900 px-[12px] py-[4px] rounded-lg shadow-[2px_2px_0px_#0f172a]">
                                ...
                                <span
                                  className="font-black text-[16px] text-slate-900"
                                  style={{ fontFamily: "var(--font-impact)" }}
                                >
                                  {activeProf.price}
                                </span>
                        ...
                        <div className="mt-[24px] bg-white border-[2.5px] border-[var(--border-color)] rounded-[16px] p-[16px]">
                          <div className="flex justify-between items-center mb-[12px]">
                            <span
                              className="font-bold text-[11px] uppercase tracking-widest text-[var(--text-muted)]"
                              style={{ fontFamily: "var(--font-body)" }}
                            >
                              SALDO KAMU
                            </span>
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`font-black text-[18px] ${balance - activeProf.price < 0 ? "text-red-500" : "text-green-600"}`}
                              style={{ fontFamily: "var(--font-impact)" }}
                            >
                        ...
                        {balance - activeProf.price < 0 && (
                          <div className="bg-orange-100 border-[2.5px] border-orange-500 rounded-[12px] p-[16px] mt-[16px] flex items-center justify-between shadow-[4px_4px_0px_#f97316]">
                            <div className="flex items-center gap-[8px]">
                              ...
                              <span
                                className="font-black text-[12px] uppercase text-orange-600"
                                style={{ fontFamily: "var(--font-body)" }}
                              >
                                Koin tidak cukup!
                              </span>
                            ...
                            <span
                              ...
                              className="font-black text-[11px] uppercase bg-orange-500 text-white px-[12px] py-[6px] rounded-md cursor-pointer border-[2px] border-orange-700 hover:-translate-y-0.5 transition-transform"
                              style={{ fontFamily: "var(--font-body)" }}
                            >
                              TAMBAH KOIN
                            </span>
                      ...
                      <div className="p-[20px_28px] border-t-[2.5px] border-[var(--border-color)] bg-white flex gap-[12px]">
                        <button
                          ...
                          className="flex-[2] bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[12px] py-[14px] font-black text-[13px] uppercase tracking-widest text-[var(--text-color)] hover:bg-[var(--text-color)] hover:text-white transition-colors shadow-[2px_2px_0px_var(--shadow-color)]"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          KEMBALI
                        </button>
                        <button
                          ...
                          className="flex-[3] bg-yellow-400 border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] rounded-[12px] py-[14px] font-black text-[13px] uppercase tracking-widest text-slate-900 hover:-translate-y-1 transition-all disabled:opacity-50 flex items-center justify-center gap-[8px]"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                  ...
                  {modalStep === 3 && activeProf && (
                    <motion.div
                      ...
                      animate="center"
                      exit="exit"
                      className="absolute inset-0 flex flex-col items-center justify-center p-[40px_28px] bg-green-50"
                    >
                      <motion.div
                        initial={{ scale: 0 }}
                      ...
                      <div
                        className="font-black text-[32px] text-slate-900 text-center uppercase leading-none"
                        style={{ fontFamily: "var(--font-impact)" }}
                      >
                        REQUEST BERHASIL!
                      </div>
                      <div
                        className="font-bold text-[14px] text-green-800 text-center mt-[12px] max-w-[300px]"
                        style={{ fontFamily: "var(--font-body)" }}
                      >
                        Review untuk <span className="font-black">{selectedProject?.name}</span>{" "}
                        telah diteruskan ke {activeProf.name}.
                      </div>

                      <button
                        onClick={closeModal}
                        className="w-full max-w-[300px] bg-blue-600 border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] hover:shadow-[6px_6px_0px_#0f172a] hover:-translate-y-1 rounded-[12px] py-[14px] font-black text-[13px] uppercase tracking-widest text-white mt-[40px] transition-all"
                        style={{ fontFamily: "var(--font-body)" }}
                      >
                        SELESAI
                      </button>
