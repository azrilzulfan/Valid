...
import { X, Play, Clock, CheckCircle2, ChevronLeft, Star, Send, AlertCircle } from "lucide-react";
    ...
    <div className="flex flex-col w-full min-h-screen bg-[#F0F4F8] text-[var(--text-color)] font-sans">
      ...
      <div className="flex items-center justify-between px-[24px] py-[16px] bg-white border-b-[3px] border-slate-900 sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div
              className="font-black text-[18px] text-slate-900 leading-tight uppercase tracking-tight"
        ...
        <div className="hidden sm:flex items-center gap-3">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-100 border-[2px] border-yellow-500 rounded-full">
            ...
            <span
              className="font-black text-[10px] text-yellow-700 uppercase tracking-widest"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Batas Waktu: 2 Hari
            </span>
      ...
      <div className="flex-1 flex flex-col lg:flex-row w-full max-w-[1400px] mx-auto p-[16px] lg:p-[32px] gap-[32px]">
        ...
        <div className="flex-1 flex flex-col gap-[24px]">
          ...
          <div className="bg-white rounded-[1.5rem] border-[3px] border-slate-900 shadow-[6px_6px_0px_#0f172a] p-[24px]">
            <div className="flex items-start gap-4">
              <div className="w-[80px] h-[80px] rounded-[16px] border-[3px] border-slate-900 bg-blue-100 flex items-center justify-center shadow-[4px_4px_0px_#0f172a] shrink-0">
                <span
                  className="font-black text-[32px] text-blue-600"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  B
                </span>
              ...
              <div>
                <h3
                  className="font-black text-[24px] md:text-[28px] text-slate-900 uppercase tracking-tight leading-none mb-1"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  Budi Santoso
                </h3>
                <p
                  className="font-bold text-[12px] md:text-[13px] text-slate-500 uppercase tracking-widest mb-3"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                ...
                <div className="flex flex-wrap gap-2">
                  <span
                    className="px-2 py-1 bg-slate-100 border-[2px] border-slate-900 rounded-md font-black text-[9px] uppercase tracking-widest text-slate-700"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Pengelasan
                  </span>
            ...
            <p
              className="mt-5 font-bold text-[13px] text-slate-600 leading-relaxed border-t-[2.5px] border-dashed border-slate-200 pt-4"
              style={{ fontFamily: "var(--font-body)" }}
            >
              "Saya adalah inspektur *quality control* dengan pengalaman 3 tahun di industri
              manufaktur, berfokus pada efisiensi proses produksi dan meminimalisir tingkat cacat
              produk."
            </p>
          </div>
          ...
          <div className="bg-blue-600 rounded-[1.5rem] border-[3px] border-slate-900 shadow-[6px_6px_0px_#0f172a] p-[24px] text-white">
            <div className="flex justify-between items-center mb-[20px]">
              ...
              <div
                className="px-3 py-1 bg-white border-[2px] border-slate-900 text-slate-900 rounded-full font-black text-[10px] uppercase tracking-widest shadow-[2px_2px_0px_#0f172a]"
                style={{ fontFamily: "var(--font-body)" }}
              >
                Skor: 78/100
              </div>
              ...
              {[
                ...
                <div key={i} className="flex flex-col">
                  ...
                  <div className="w-full h-[6px] bg-blue-900/50 border border-slate-900 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-yellow-400 border-r border-slate-900 rounded-r-full"
                      style={{ width: `${m.score}%` }}
                    />
                  </div>
                </div>
          ...
          <div className="bg-white rounded-[1.5rem] border-[3px] border-slate-900 shadow-[6px_6px_0px_#0f172a] overflow-hidden flex flex-col flex-1">
            ...
            <div className="p-[24px] flex flex-col gap-4 overflow-y-auto max-h-[350px]">
              ...
              <div className="border-[2.5px] border-slate-900 rounded-xl p-4 hover:bg-slate-50 transition-colors group cursor-pointer">
                <h4
                  className="font-black text-[14px] text-slate-900 uppercase group-hover:text-blue-600 transition-colors"
                  style={{ fontFamily: "var(--font-impact)" }}
                >
                  Sistem Inspeksi Otomatis
                </h4>
                <p
                  className="font-bold text-[11px] text-slate-500 uppercase tracking-widest mt-1 mb-2"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  PT. Manufaktur Sukses • 2025
                </p>
                <p
                  className="font-bold text-[12px] text-slate-600 leading-relaxed"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Merancang sistem inspeksi visual berbasis komputer untuk mendeteksi cacat mikro
                  pada komponen mesin, mengurangi tingkat kecacatan produk hingga 15%.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  <span
                    className="text-[10px] bg-blue-100 border-[2px] border-blue-200 text-blue-700 px-2 py-1 rounded-md font-black uppercase tracking-widest"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Computer Vision
                  </span>
              ...
              <div className="border-[2.5px] border-slate-900 rounded-xl p-4 hover:bg-slate-50 transition-colors group cursor-pointer">
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Menganalisis dan memprogram ulang jalur permesinan pada mesin CNC untuk mengurangi
                  waktu pemotongan sebesar 10% tanpa mengorbankan kualitas.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  <span
                    className="text-[10px] bg-blue-100 border-[2px] border-blue-200 text-blue-700 px-2 py-1 rounded-md font-black uppercase tracking-widest"
        ...
        <div className="flex-1 lg:max-w-[500px] flex flex-col bg-white rounded-[1.5rem] border-[3px] border-slate-900 shadow-[8px_8px_0px_#0f172a] overflow-hidden">
          ...
          <div className="p-[24px] flex-1 overflow-y-auto flex flex-col gap-[20px]">
            ...
            <div>
              <label
                className="font-black text-[11px] text-slate-900 uppercase tracking-widest block mb-2"
                style={{ fontFamily: "var(--font-body)" }}
              >
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star
                      className={`w-6 h-6 ${rating >= star ? "fill-yellow-400 text-yellow-500" : "text-slate-300"}`}
                    />
                  </button>
                ))}
              </div>
            ...
            <div className="bg-yellow-50 border-[2px] border-dashed border-yellow-400 p-3 rounded-xl flex items-start gap-3 mt-2">
              ...
              <p
                className="font-bold text-[10px] text-yellow-800 leading-relaxed uppercase tracking-wider"
                style={{ fontFamily: "var(--font-body)" }}
              >
                Dengan menekan Kirim, review akan dikirim secara permanen ke dashboard kandidat dan
                Koin Anda akan bertambah.
              </p>
            </div>
          </div>
