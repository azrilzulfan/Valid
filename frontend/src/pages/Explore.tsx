      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto bg-[var(--bg-a)] relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col md:flex-row gap-[16px] mb-[40px]"
          >
            ...
            {DUMMY_STRANGERS.map((person) => (
              ...
              >
                ...
                <div className="flex flex-col items-center shrink-0">
                  <div
                    className={`w-[80px] h-[80px] rounded-full border-[3px] border-slate-900 ${person.color} flex items-center justify-center shadow-[4px_4px_0px_#0f172a] mb-[16px]`}
                  >
                    <span
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <button
                    onClick={() =>
                      window.open(`/p/${person.name.toLowerCase().replace(/ /g, "-")}`, "_blank")
                    }
