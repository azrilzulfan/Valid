      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto bg-[var(--bg-a)] relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => window.open("/p/rizky", "_blank")}
          ...
          >
            ...
            <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                Fresh Graduate Teknik Mesin — SMK Negeri 1 Bandung
              </p>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-2 mt-[16px]">
                {["PENGELASAN", "CNC MACHINING"].map((skill) => (
                  <span
                    key={skill}
                    className="bg-blue-100 dark:bg-blue-900/30 border-[2px] border-blue-600 text-blue-700 dark:text-blue-400 rounded-full px-[14px] py-[6px] font-black text-[10px] uppercase tracking-widest shadow-[2px_2px_0px_#2563EB]"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {skill}
                  </span>
                ...
                {["AUTOCAD", "QUALITY CONTROL"].map((skill) => (
                  <span
                    key={skill}
                    className="bg-[var(--bg-a)] border-[2px] border-[var(--border-color)] text-[var(--text-color)] rounded-full px-[14px] py-[6px] font-black text-[10px] uppercase tracking-widest shadow-[2px_2px_0px_var(--shadow-color)]"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    {skill}
                  </span>
            ...
            <button
              ...
              className="w-full md:w-auto bg-[var(--card-bg)] border-[2.5px] border-[var(--border-color)] text-[var(--text-color)] rounded-[1rem] px-[20px] py-[12px] font-black text-[12px] uppercase tracking-wider hover:-translate-y-1 hover:border-blue-600 hover:text-blue-600 shadow-[3px_3px_0px_var(--shadow-color)] transition-all"
              style={{ fontFamily: "var(--font-body)" }}
            >
              Edit Profil
            </button>
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-[20px]">
              ...
              <span
                className="font-bold text-[11px] text-[var(--text-muted)] mt-1 sm:mt-0"
                style={{ fontFamily: "var(--font-body)" }}
              >
                Dari Wawancara AI + Review Profesional
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] mb-[20px]">
              {[
                {
                  name: "Pengelasan",
                  source: "Terverifikasi · Wawancara AI + Budi Santoso",
                  verified: true,
                },
                ...
                <div
                  key={i}
                  className="flex items-center gap-[16px] bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[1rem] p-[16px_20px] shadow-[2px_2px_0px_var(--shadow-color)] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_var(--shadow-color)] transition-all cursor-default"
                >
                  <div
                    className={`w-[40px] h-[40px] shrink-0 rounded-full border-[2px] border-slate-900 flex items-center justify-center ${skill.verified ? "bg-blue-100 text-blue-600" : "bg-yellow-100 text-yellow-600"}`}
                  >
                    {skill.verified ? (
                  ...
                  <div>
                    <div
                      className="font-black text-[14px] text-[var(--text-color)] uppercase tracking-wide"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {skill.name}
                    </div>
                    <div
                      className="font-bold text-[10px] text-[var(--text-muted)] uppercase tracking-widest mt-[2px]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {skill.source}
                    </div>
            ...
            <button
              className="w-full bg-[var(--bg-a)] border-[2.5px] border-dashed border-[var(--border-color)] text-[var(--text-muted)] rounded-[1rem] p-[16px] font-black text-[12px] uppercase tracking-wider hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors"
              style={{ fontFamily: "var(--font-body)" }}
            >
              + Tambah Skill Manual
            </button>
              ...
              {[
                {
                  ...
                  year: "2026",
                  score: 78,
                  metrics: "KONTAK MATA 84% · KEPERCAYAAN DIRI 71% · KOMUNIKASI 79%",
                },
                {
                  date: "22 Mar",
                  year: "2026",
                  score: 65,
                  metrics: "KONTAK MATA 70% · KEPERCAYAAN DIRI 58% · KOMUNIKASI 68%",
                },
                {
                  date: "15 Feb",
                  year: "2026",
                  score: 55,
                  metrics: "KONTAK MATA 60% · KEPERCAYAAN DIRI 48% · KOMUNIKASI 57%",
                },
              ].map((sess, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <div className="flex-1 pb-[8px]">
                    ...
                    <div
                      className="font-bold text-[10px] sm:text-[11px] text-[var(--text-muted)] uppercase tracking-widest mt-[8px] leading-relaxed"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {sess.metrics}
                    </div>
                    <div
                      className="font-black text-[11px] text-blue-600 uppercase tracking-widest mt-[12px] cursor-pointer hover:underline"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      Lihat Detail →
                    </div>
          ...
          <motion.div variants={sectionVariants}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
              {[
                {
                  title: "Mesin Las MIG Otomatis",
                  tech: ["CNC", "PENGELASAN"],
                  desc: "Merancang sistem otomasi mesin las MIG untuk meningkatkan presisi dan efisiensi produksi.",
                  date: "Mei 2026",
                },
                {
                  title: "Sistem Quality Control",
                  tech: ["AUTOCAD", "QC"],
                  desc: "Membangun prosedur quality control untuk lini produksi komponen otomotif.",
                  date: "Apr 2026",
                },
                {
                  title: "Desain Jig & Fixture",
                  tech: ["AUTOCAD", "CNC"],
                  desc: "Mendesain jig dan fixture untuk proses manufaktur presisi tinggi.",
                  date: "Feb 2026",
                },
                {
                  title: "Laporan Magang Industri",
                  tech: ["DOKUMENTASI"],
                  desc: "Dokumentasi lengkap pengalaman magang di PT Astra Manufacturing.",
                  date: "Jan 2026",
                },
              ].map((proj, i) => (
                <motion.div
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-[24px]">
                ...
                <button
                  onClick={() => setIsAddProjectOpen(false)}
                  className="p-2 hover:bg-[var(--bg-a)] rounded-full transition-colors"
                >
              ...
              <div className="flex flex-col gap-[20px]">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-[1rem] px-[16px] py-[14px] font-bold text-[14px] text-[var(--text-color)] focus:outline-none focus:border-blue-600 focus:shadow-[4px_4px_0px_#2563EB] transition-all placeholder:text-[var(--text-muted)]/50"
                    style={{ fontFamily: "var(--font-body)" }}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {/* Dummy tags */}
                    <span
                      className="bg-blue-100 border-[2px] border-blue-600 text-blue-700 rounded-full px-[12px] py-[6px] font-black text-[10px] uppercase tracking-widest flex items-center gap-1 shadow-[2px_2px_0px_#2563EB]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                ...
                <div>
                  ...
                  <div className="w-full bg-[var(--bg-a)] border-[2.5px] border-dashed border-[var(--border-color)] rounded-[1.5rem] p-[32px] flex flex-col items-center justify-center cursor-pointer hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-colors group">
                    ...
                    <span
                      className="font-black text-[13px] text-[var(--text-color)] uppercase tracking-wide"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
              ...
              <div className="flex gap-[16px] mt-[32px]">
                <button
                  onClick={() => setIsAddProjectOpen(false)}
                  className="flex-1 bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] text-[var(--text-color)] rounded-[1rem] py-[14px] font-black text-[13px] uppercase tracking-wider hover:border-slate-900 hover:shadow-[3px_3px_0px_#0f172a] transition-all"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Batal
                </button>
                <button
                  className="flex-1 bg-blue-600 border-[2.5px] border-slate-900 text-white rounded-[1rem] py-[14px] font-black text-[13px] uppercase tracking-wider shadow-[3px_3px_0px_#0f172a] hover:shadow-[5px_5px_0px_#0f172a] hover:-translate-y-0.5 transition-all"
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Simpan Proyek
                </button>
