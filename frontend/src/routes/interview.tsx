  ...
  return (
    ...
    >
      <AnimatePresence mode="wait">
        {currentStep === 1 && (
          <Step1 key="step1" setStep={setCurrentStep} isDark={isDark} toggleTheme={toggleTheme} />
        )}
        {currentStep === 2 && (
          <Step2 key="step2" setStep={setCurrentStep} isDark={isDark} toggleTheme={toggleTheme} />
        )}
        {currentStep === 3 && (
          <Step3
            key="step3"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ padding: "80px 7vw 40px", gap: "60px" }}
      >
        {/* LEFT COLUMN */}
        <div style={{ width: "100%", flexBasis: "55%" }}>
          ...
          >
            Jawab 5 pertanyaan di depan kamera. Sistem kami menganalisis kontak mata, kepercayaan
            diri, dan pola komunikasi kamu secara real-time — langsung di browser, tanpa data yang
            dikirim ke server.
          </p>
    ...
    >
      ...
      <div style={{ maxWidth: "540px", margin: "0 auto" }}>
        ...
        <div style={{ marginTop: "36px", display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Diperlukan untuk analisis kontak mata
              </div>
            </div>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Diperlukan untuk analisis suara
              </div>
            </div>
            <CheckCircle color="var(--primary)" size={18} />
          </div>
        ...
        >
          ...
          >
            Semua analisis berjalan langsung di browser kamu. Tidak ada video atau audio yang
            dikirim atau disimpan ke server kami tanpa izin kamu.
          </p>
        </div>
      ...
      <div style={{ maxWidth: "780px", margin: "0 auto", padding: "48px 7vw 80px" }}>
        ...
        <div style={{ marginTop: "40px" }}>
          ...
          >
            ...
            >
              Kamu menunjukkan performa yang cukup baik dalam sesi ini. Kepercayaan diri dan
              kemampuan komunikasi berada di atas rata-rata untuk lulusan vokasi.
            </div>
          </div>
          ...
          >
            ...
            >
              Latih wawancara minimal 3 kali seminggu dan rekam diri sendiri untuk evaluasi mandiri.
              Fokus pada kejelasan jawaban dan minimalkan kata pengisi.
            </div>
          </div>
        </div>
            ...
            {["Pengelasan", "CNC Machining", "Quality Control", "AutoCAD"].map((skill) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "999px",
                  transition:
                    "background-color 500ms ease, border-color 500ms ease, color 500ms ease",
                }}
              >
                {skill}
              </div>
        ...
        >
          <div style={{ flex: 1 }}>
            ...
            >
              Tambahkan hasil wawancara ini ke portfolio agar perekrut bisa melihat kemampuan
              komunikasimu.
            </div>
            <button
