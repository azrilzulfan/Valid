  ...
  head: () => ({
    meta: [
      { title: "VALID — Buktikan Kemampuanmu" },
      {
        name: "description",
        content:
          "Platform verifikasi peer berbasis AI buat pekerja vokasi Indonesia. Bukti nyata, wawancara AI, dan validasi ahli industri.",
      },
      { property: "og:title", content: "VALID — Buktikan Kemampuanmu" },
      {
        property: "og:description",
        content: "Verifikasi skill yang jujur dan berbasis bukti untuk pekerja vokasi Indonesia.",
      },
    ],
  }),
  component: Index,
