...
const TRANSACTIONS = [
  ...
  { id: 3, type: "withdraw", title: "Penarikan ke Rekening BCA", date: "22 Mei 2026, 11:00", amount: 1000 },
              ...
              <motion.div variants={sectionVariants} className="bg-slate-900 border-[3px] border-slate-900 rounded-[1.5rem] p-[32px] shadow-[8px_8px_0px_#FBBF24] relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-end gap-2 mb-1">
                    <span className="font-black text-[56px] text-white leading-none tracking-tighter" style={{ fontFamily: 'var(--font-impact)' }}>1200</span>
