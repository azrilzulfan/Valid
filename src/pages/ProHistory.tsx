...
const PAST_REVIEWS = [
  { id: 3, name: "Fajar Nugraha", role: "Drafter AutoCAD", dateCompleted: "23 Mei 2026", aiScore: 85, proScore: 90, comment: "Kandidat sangat paham membaca gambar teknik. Perlu ditingkatkan dalam komunikasi presentasi." },
  { id: 9, name: "Rina Melati", role: "UI/UX Designer", dateCompleted: "15 Mei 2026", aiScore: 78, proScore: 85, comment: "Portofolio sangat rapi, proses desain dijelaskan dengan baik." },
  { id: 10, name: "Hendro Wibowo", role: "Teknisi Mesin", dateCompleted: "10 Mei 2026", aiScore: 92, proScore: 88, comment: "Pemahaman teori bagus, tapi praktiknya masih perlu pembuktian." },
];
      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          <motion.div variants={sectionVariants} className="grid grid-cols-1 gap-[24px]">
            {PAST_REVIEWS.filter(req => req.name.toLowerCase().includes(search.toLowerCase())).map((req) => (
