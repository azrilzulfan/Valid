            ...
            <motion.div variants={itemVariants} className="bg-[var(--card-bg)] border-[3.5px] border-[var(--border-color)] rounded-[2rem] p-6 sm:p-8 shadow-[8px_8px_0px_var(--shadow-color)] relative">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-col gap-3">
                  {/* Pencari Kerja */}
                  <div onClick={() => navigate({ to: '/dashboard' })} className="group flex items-center justify-between p-4 bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-2xl cursor-pointer transition-all duration-300 shadow-[4px_4px_0px_var(--shadow-color)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_var(--shadow-color)]">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-bold text-[var(--text-color)] text-sm uppercase tracking-wide">Pencari Kerja</span>
                    </div>
                    <span className="font-black text-xl text-[var(--text-color)] transform group-hover:translate-x-1 transition-transform">→</span>
                  </div>

                  {/* Profesional BNSP */}
                  <div onClick={() => navigate({ to: '/pro/dashboard' as any })} className="group flex items-center justify-between p-4 bg-[var(--bg-a)] border-[2.5px] border-[var(--border-color)] rounded-2xl cursor-pointer transition-all duration-300 shadow-[4px_4px_0px_var(--shadow-color)] hover:-translate-y-1 hover:shadow-[6px_6px_0px_var(--shadow-color)]">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="font-bold text-[var(--text-color)] text-sm uppercase tracking-wide">Profesional BNSP</span>
                    </div>
                    <span className="font-black text-xl text-[var(--text-color)] transform group-hover:translate-x-1 transition-transform">→</span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center my-6 gap-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-[var(--text-muted)]">atau</span>
                <div className="h-[2.5px] bg-[var(--border-color)] opacity-20 flex-1"></div>
              </div>
