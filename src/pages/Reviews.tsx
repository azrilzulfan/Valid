...
import { LayoutDashboard, FolderOpen, Mic, Star, Users, Coins, LogOut, ChevronRight, X, CheckCircle2, Hourglass, XCircle, Download, Compass } from 'lucide-react';
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center p-[24px_32px] border-b-[3.5px] border-slate-900 bg-white sticky top-0 z-20">
                ...
                <button onClick={() => setIsPanelOpen(false)} className="w-[36px] h-[36px] bg-white border-[2.5px] border-slate-900 shadow-[3px_3px_0px_#0f172a] rounded-lg flex items-center justify-center hover:-translate-y-0.5 transition-transform"><X className="w-5 h-5 text-slate-900" /></button>
              </div>
                      ...
                      <div className="bg-white border-[3px] border-slate-900 rounded-[20px] p-[24px] shadow-[6px_6px_0px_#0f172a]">
                        <div className="flex items-center gap-[12px] mb-[16px]">
                          <div className="w-[40px] h-[40px] rounded-[10px] border-[2px] border-slate-900 flex items-center justify-center font-black text-[16px] text-white" style={{ background: selectedReview.gradient, fontFamily: 'var(--font-impact)' }}>
                            {selectedReview.reviewerName.split(' ').map(n => n[0]).join('')}
                          </div>
                          <div>
