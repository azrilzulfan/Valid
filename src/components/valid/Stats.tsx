// HALAMAN: C:\laragon\www\valid-react\src\components\valid\Stats.tsx
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute -top-[20%] -left-[10%] w-[70vw] h-[70vw] bg-blue-100/60 dark:bg-blue-900/10 rounded-full blur-[100px] mix-blend-multiply dark:mix-blend-screen opacity-70 animate-pulse" style={{ animationDuration: '8s' }} />
        <div className="absolute top-[20%] -right-[10%] w-[60vw] h-[60vw] bg-rose-100/50 dark:bg-rose-900/10 rounded-full blur-[100px] mix-blend-multiply dark:mix-blend-screen opacity-60 animate-pulse" style={{ animationDuration: '10s' }} />
        <div className="absolute -bottom-[20%] left-[20%] w-[80vw] h-[80vw] bg-amber-50/50 dark:bg-slate-900/10 rounded-full blur-[120px] mix-blend-multiply dark:mix-blend-screen opacity-70 animate-pulse" style={{ animationDuration: '12s' }} />
      </div>
      ...
      <div className="absolute top-0 left-0 h-full w-full md:w-[45vw] flex flex-col justify-start md:justify-center pt-28 md:pt-0 px-6 md:px-16 z-20 pointer-events-none">
        ...
        <p className="mt-8 md:mt-12 max-w-sm text-base md:text-lg text-[var(--text-color)] font-medium font-body leading-relaxed bg-[var(--card-bg)] p-5 rounded-2xl border-2 border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] hidden md:block pointer-events-auto transition-all duration-350">
          Klaim fiktif dan dokumen bodong membuat proses rekrutmen penuh keraguan. VALID hadir untuk memutus siklus ini.
        </p>
      </div>
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden z-10 pointer-events-none">
        ...
        >
          ...
          {problems.map((p, i) => (
            <div key={i} className="w-[85vw] md:w-[50vw] shrink-0 flex items-center justify-center px-4 md:px-8 relative z-10">
              ...
              <div className="w-full relative flex flex-col justify-center max-w-2xl mx-auto group">
                ...
                <div className="flex flex-col gap-5 md:gap-6 items-start relative z-10 w-full">
                  ...
                  <div className={`p-4 md:p-5 rounded-[1.2rem] md:rounded-[1.5rem] border-2 md:border-[3px] border-[var(--border-color)] shadow-[4px_4px_0px_var(--shadow-color)] transform -rotate-3 ${p.bg} ${p.color} shrink-0 bg-[var(--card-bg)] transition-transform duration-500 group-hover:rotate-0 group-hover:-translate-y-1`}>
                  ...
                  <div className="flex flex-col p-6 md:p-8 bg-[var(--card-bg)] rounded-[1.5rem] md:rounded-[2rem] border-2 md:border-[3px] border-[var(--border-color)] shadow-[6px_6px_0px_var(--shadow-color)] md:shadow-[8px_8px_0px_var(--shadow-color)] w-full transition-all duration-500 group-hover:shadow-[4px_4px_0px_var(--shadow-color)] group-hover:translate-y-1 group-hover:translate-x-1">
                    <h3 
                      className="text-2xl md:text-4xl font-extrabold text-[var(--text-color)] uppercase leading-tight mb-3 md:mb-4 tracking-tight" 
                    >
                      {p.title}
                    </h3>
