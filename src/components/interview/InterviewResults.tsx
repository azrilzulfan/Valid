...
export function Step5({ setStep, setCurrentQ, navigate, isDark, toggleTheme }: { setStep: (s: number) => void; setCurrentQ: (q: number) => void; navigate: any; isDark: boolean; toggleTheme: () => void }) {
