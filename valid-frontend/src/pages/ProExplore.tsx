...
// FUNGSI: Menampilkan dan mencari portofolio real dari para mahasiswa/kandidat secara umum
// API YANG DIBUTUHKAN: portfolioApi.getPublicPortfolios(), dashboardApi.getReviewerDashboard()
      ...
      <div className="flex-1 h-[calc(100vh-75px)] md:h-screen overflow-y-auto relative pb-[100px] md:pb-[40px]">
        ...
        >
          ...
          >
            <div>
              <div
                className="inline-flex px-3 py-1 bg-yellow-100 dark:bg-yellow-950/50 border-[2.5px] border-slate-900 rounded-full font-black text-[10px] uppercase tracking-widest text-yellow-700 dark:text-yellow-400 mb-[16px] shadow-[2px_2px_0px_#0f172a]"
                style={{ fontFamily: "var(--font-body)" }}
              >
                EKSPLORASI TALENTA MAHASISWA
              </div>
              <h1
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                Jelajahi profil portofolio mahasiswa secara terbuka dan berikan evaluasi guna
                standardisasi kompetensi kelulusan mereka.
              </p>
            </div>
            ...
            <div className="relative w-full lg:w-[400px]">
              ...
              <input
                ...
                placeholder="Cari keahlian, posisi, atau nama..."
          ...
          >
            ...
            {!loading &&
              candidates.filter(
                (c: any) =>
                  (c.name || c.title || c.candidateName || "")
                    .toLowerCase()
                    .includes(search.toLowerCase()) ||
                  (c.role || c.vocationField || c.category || "")
                    .toLowerCase()
                    .includes(search.toLowerCase()),
              ).length === 0 && (
                <div
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Tidak ada kandidat talenta digital yang cocok.
                </div>
              )}
              ...
              candidates
                ...
                .map((candidate: any, idx) => {
                  const nameText =
                    ...
                    "Digital Talent";
                  const roleText =
                    candidate.role || candidate.vocationField || candidate.category || "Generalist";
                  const idReview = candidate.id || candidate.portfolioId || candidate._id;
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start mb-[20px]">
                        ...
                        <div className="flex items-center gap-1.5 px-3 py-1 bg-yellow-100 dark:bg-yellow-950/50 border-[2px] border-yellow-400 rounded-full">
                          <Star className="w-3 h-3 text-yellow-500 fill-yellow-500" />
                          <span
                            className="font-black text-[10px] text-yellow-700 dark:text-yellow-400 tracking-widest"
                            style={{ fontFamily: "var(--font-body)" }}
                          >
                            {candidate.match || candidate.aiScore || candidate.initialScore || 75}%
                            ASESMEN
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="mb-[20px]">
                        <h3
                          className="font-black text-[20px] text-[var(--text-color)] uppercase tracking-tight leading-none mb-1.5"
                          style={{ fontFamily: "var(--font-impact)" }}
                        >
                          {nameText}
                        </h3>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {(candidate.skills || candidate.tags || ["Teknologi"]).map(
                      ...
                      {/* Actions */}
                      <div className="mt-auto flex flex-col sm:flex-row gap-3 pt-4 border-t-[2.5px] border-dashed border-slate-200 dark:border-slate-800">
                        <button
                          onClick={() =>
                            navigate({
                              to: `/p/${candidate.username || candidate.uid || "unknown"}`,
                            })
                          }
                        ...
                        <button
                          onClick={() => navigate({ to: `/pro/review/${idReview}` })}
