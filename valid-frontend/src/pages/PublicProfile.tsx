    ...
    <div className="min-h-screen bg-[var(--bg-a)] text-[var(--text-color)] font-sans flex flex-col">
      ...
      <nav className="fixed top-0 left-0 w-full h-[70px] bg-white border-b-[3px] border-slate-900 shadow-[0_4px_0px_#0f172a] z-50 flex items-center justify-between px-[20px] md:px-[40px]">
        ...
        <button
          ...
          style={{ fontFamily: "var(--font-body)" }}
        >
          <span className="hidden sm:inline">Buat Portofoliomu</span>
          <span className="sm:hidden">Daftar</span> <ArrowRight className="w-4 h-4" />
        </button>
      </nav>
            ...
            <div className="relative flex flex-col md:flex-row gap-[32px] items-center md:items-start pt-[40px]">
              ...
              <div className="flex-1 text-center md:text-left z-10 mt-[20px] md:mt-0">
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Saya adalah lulusan Teknik Mesin yang bersemangat dalam bidang manufaktur
                  otomotif. Fokus utama saya adalah desain dengan AutoCAD dan operasional mesin CNC.
                  Sedang mencari peluang untuk berkembang di industri.
                </p>

                <div className="flex flex-wrap justify-center md:justify-start gap-[12px] mt-[24px]">
                  <button
                    className="bg-slate-900 text-white rounded-[12px] px-[24px] py-[14px] font-black text-[13px] uppercase tracking-widest border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#64748B] hover:-translate-y-1 transition-all"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
                    Hubungi Saya
                  </button>
                  <button
                    className="bg-white text-slate-900 rounded-[12px] px-[24px] py-[14px] font-black text-[13px] uppercase tracking-widest border-[2.5px] border-slate-900 shadow-[4px_4px_0px_#0f172a] hover:-translate-y-1 transition-all flex items-center gap-2"
                    style={{ fontFamily: "var(--font-body)" }}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[32px]">
            ...
            >
              ...
              <div className="flex flex-wrap gap-[12px]">
                {["Autodesk AutoCAD", "SolidWorks", "Operasi CNC", "QC/QA", "Pengelasan Dasar"].map(
                  (skill, i) => (
                    <div
                      key={i}
              ...
              {DUMMY_PROJECTS.map((project, i) => (
                ...
                >
                  ...
                  <div className="w-[calc(100%-56px)] md:w-[calc(50%-40px)] bg-white border-[3px] border-slate-900 shadow-[6px_6px_0px_var(--shadow-color)] hover:shadow-[8px_8px_0px_var(--shadow-color)] hover:-translate-y-1 transition-all rounded-[16px] p-[24px]">
                    <div
                      className="font-bold text-[11px] text-slate-400 uppercase tracking-widest mb-[8px]"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {project.date}
                    </div>
                    <h4
                      className="font-black text-[20px] text-slate-900 uppercase tracking-tight mb-[12px] leading-tight"
                      style={{ fontFamily: "var(--font-impact)" }}
                    >
                      {project.title}
                    </h4>
                    ...
                    <div className="flex flex-wrap gap-[8px] mb-[16px]">
                      {project.tech.map((t) => (
                        <span
                          key={t}
                          className="bg-slate-100 text-slate-600 border-[2px] border-slate-200 rounded-md px-[10px] py-[4px] font-black text-[9px] uppercase tracking-widest"
                          style={{ fontFamily: "var(--font-body)" }}
                        >
                          {t}
                        </span>
                    ...
                    <p
                      className="font-bold text-[13px] text-slate-600 leading-relaxed"
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      {project.desc}
                    </p>
