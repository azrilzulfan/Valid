        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div style={{ flex: 1, width: "100%" }}>
            {[
              {
                label: "Kontak Mata",
                value: `${scores?.metrics?.eyeContact || 0}%`,
                w: `${scores?.metrics?.eyeContact || 0}%`,
              },
              {
                label: "Kepercayaan Diri",
                value: `${scores?.metrics?.confidence || 0}%`,
                w: `${scores?.metrics?.confidence || 0}%`,
              },
              {
                label: "Komunikasi",
                value: `${scores?.metrics?.communication || 0}%`,
                w: `${scores?.metrics?.communication || 0}%`,
              },
            ].map((m, i) => (
